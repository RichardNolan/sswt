...
class OrderItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_item" do
    assert_difference('OrderItem.count') do
      post order_items_url, params: { order_item: { hamper_id: @order_item.hamper_id, order_id: @order_item.order_id } }
    end
  ...
  test "should update order_item" do
    patch order_item_url(@order_item), params: { order_item: { hamper_id: @order_item.hamper_id, order_id: @order_item.order_id } }
