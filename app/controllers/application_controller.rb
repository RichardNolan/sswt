class ApplicationController < ActionController::Base
  ...
  protected
    ...
    def configure_permitted_parameters
      ...
      devise_parameter_sanitizer.permit(:sign_up, keys: [:name, :address, :address2, :contact_phone, :county_id])
      devise_parameter_sanitizer.permit(:account_update, keys: [:name, :address, :address2, :contact_phone, :county_id])
    end
end